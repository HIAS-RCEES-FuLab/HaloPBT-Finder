...
pos_kept.to_csv("filtered_mona_POS_allowed_elements.csv", index=False)
neg_kept.to_csv("filtered_mona_NEG_allowed_elements.csv", index=False)

print("MONA POS retained:", len(pos_kept))
print("MONA NEG retained:", len(neg_kept))