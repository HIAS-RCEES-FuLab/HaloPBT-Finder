...
pos_kept.to_csv("filtered_nist_POS_allowed_elements.csv", index=False)
neg_kept.to_csv("filtered_nist_NEG_allowed_elements.csv", index=False)

print("NIST POS retained:", len(pos_kept))
print("NIST NEG retained:", len(neg_kept))