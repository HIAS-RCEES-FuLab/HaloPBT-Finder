...
# ============================
input_dir = r"D:\MSMS\MSMS_ClBr_H+H-\MONA"
...
# ============================
files = {
    "ClBr_POS": os.path.join(input_dir, "filtered_mona_POS_with_ClBr.csv"),
    "ClBr_NEG": os.path.join(input_dir, "filtered_mona_NEG_with_ClBr.csv"),
    "noClBr_POS": os.path.join(input_dir, "filtered_mona_POS_no_ClBr.csv"),
    "noClBr_NEG": os.path.join(input_dir, "filtered_mona_NEG_no_ClBr.csv"),
}
...
def sample_no_clbr(noclbr_df, clbr_df, ratio=2, max_peaks=500, random_state=42):
    """
    对不含 Cl/Br 的谱图进行抽样，使其数量是含 Cl/Br 样本的 ratio 倍
    """
...
# ============================
sampled_noClBr_POS.to_csv(os.path.join(output_dir, "filtered_mona_POS_no_ClBr_sampled.csv"), index=False)
sampled_noClBr_NEG.to_csv(os.path.join(output_dir, "filtered_mona_NEG_no_ClBr_sampled.csv"), index=False)
