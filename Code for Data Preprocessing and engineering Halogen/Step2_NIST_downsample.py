...
# ============================
input_dir = r"D:\MSMS\MSMS_ClBr_H+H-\NIST"
...
# ============================
files = {
    "ClBr_POS": os.path.join(input_dir, "filtered_nist_POS_with_ClBr.csv"),
    "ClBr_NEG": os.path.join(input_dir, "filtered_nist_NEG_with_ClBr.csv"),
    "noClBr_POS": os.path.join(input_dir, "filtered_nist_POS_no_ClBr.csv"),
    "noClBr_NEG": os.path.join(input_dir, "filtered_nist_NEG_no_ClBr.csv"),
}
...
# ============================
sampled_noClBr_POS.to_csv(os.path.join(output_dir, "filtered_nist_POS_no_ClBr_sampled.csv"), index=False)
sampled_noClBr_NEG.to_csv(os.path.join(output_dir, "filtered_nist_NEG_no_ClBr_sampled.csv"), index=False)
